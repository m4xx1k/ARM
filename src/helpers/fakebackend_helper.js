...
const true_url = process.env.REACT_APP_BACKEND_URL
...
export const getFakeEULA = () => api.get('https://jsonplaceholder.typicode.com/posts?limit=10')
export const getEULA = () => api.get('http://52.210.189.142/api/v1/info/InfoParagraph')
export const getLocalEULA = () => [
    {
        "content": "Вітаємо! Ви успішно зареєстровані в системі та отримали права доступу. Деякий час ви будете бачити це вікно під час входу. Тут зазначаються деякі повідомлення, які допоможуть швидко опанувати систему.",
        "is_worning_type": false,
        "infoitem_set": [
            {
                "content": "Неправильних дій не існує, у вас не вийде щось зламати випадково. Система має всі необхідні підказки під час роботи."
            },
            {
                "content": "Зрозумілість опису справ з якими ви працюєте - запорука зручного користування системою та спільної роботи з колегами."
            },
            {
                "content": "Ви можете надавати доступ колегам до власних справ. Вони зможуть бачити результати аналітичних напрацювань, доповнювати їх новою інформацією та генерувати звіти"
            },
            {
                "content": "Якщо справу передано до провадження іншому відділу, ви можете повністю передати справу іншому користувачі (ви перестанете бачити справу серед переліку доступних)"
            },
            {
                "content": "Справи, які втратили актуальність можна архівувати (ви зможете повернутись до них у майбутньому)"
            },
            {
                "content": "Видалення справ допускається у разі помилкового створення або завантаження цілком помилкових даних."
            }
        ]
    },
    {
        "content": "Деяка додаткова інформація про систему:",
        "is_worning_type": false,
        "infoitem_set": [
            {
                "content": "Дані та файли, введені під час роботи з системою, опрацьовуються в межах нашої організації. Сторонні сервіси або сховища не залучаються."
            },
            {
                "content": "Опрацьовані дані використовуються для виявлення зв'язків між різними проєктами, проведення наскрізної аналітики, сигналізації про попередню роботу з вашими клієнтами або їх контактами."
            },
            {
                "content": "Конфіденційні дані (відомості про клієнтів або документи, що містять банківську таємницю) не будуть передаватись стороннім особам або іншим співробітникам компанії (якщо ви самі не надали їх доступ)."
            }
        ]
    },
    {
        "content": "Деякі ваші дії можуть бути розцінені як такі, що навмисно шкодять системі:",
        "is_worning_type": true,
        "infoitem_set": [
            {
                "content": "Створення єдиної справи, яка використовується для різних проваджень та проєктів - з метою використання аналітичних інструментів системи без реального обліку."
            },
            {
                "content": "Видалення напрацьованих аналітичних даних після отримання генерованих звітів."
            },
            {
                "content": "Зазначення завідомо недостовірних (вигаданих) даних про проєкт."
            },
            {
                "content": "Численне створення різних справ з метою штучного збільшення показників"
            }
        ]
    }
]
