...
export const LOGIN = 'v1/get-token-auth/'
export const GET_USER = 'v1/user/whoami'
export const RECOVERY_EMAIL = 'v1/user/recovery-email/'
//EULA
export const GET_ALL_EULA = 'v1/info/InfoParagraph/'

//FAQ
export const GET_ALL_FAQ = 'v1/info/InfoSubjectFAQ/'
